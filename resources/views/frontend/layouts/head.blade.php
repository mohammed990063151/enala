...
<link rel="stylesheet" id="contact-form-7-rtl-css" href="{{ asset('assets/css/styles-rtl.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-plus-elementor-css" href="{{ asset('assets/css/elementor.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-plus-common-css" href="{{ asset('assets/css/common.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-pro-widget-css" href="{{ asset('assets/css/widget.css') }}" type="text/css" media="all">
...
<link rel="stylesheet" id="woocommerce-layout-rtl-css" href="{{ asset('assets/css/woocommerce-layout-rtl.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="woocommerce-smallscreen-rtl-css" href="{{ asset('assets/css/woocommerce-smallscreen-rtl.css') }}" type="text/css" media="only screen and (max-width: 768px)">
<link rel="stylesheet" id="woocommerce-general-rtl-css" href="{{ asset('assets/css/woocommerce-rtl.css') }}" type="text/css" media="all">
...
{{-- <link rel="stylesheet" id="fontawesome-css" href="{{ asset('assets/all.min.css" type="text/css" media="all"> --}}
<link rel="stylesheet" id="material-icon-css" href="{{ asset('assets/css/material-design-iconic-font.min.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-base-css" href="{{ asset('assets/css/base.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-common-css" href="{{ asset('assets/css/common(1).css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-modules-listing-css" href="{{ asset('assets/css/modules-listing.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-modules-default-css" href="{{ asset('assets/css/modules-default.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-rtl-css" href="{{ asset('assets/css/rtl.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-social-share-frontend-css" href="{{ asset('assets/css/social-share-frontend.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="chosen-css" href="{{ asset('assets/css/chosen.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-fields-css" href="{{ asset('assets/css/fields.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-search-frontend-css" href="{{ asset('assets/css/search-frontend.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-media-images-frontend-css" href="{{ asset('assets/css/media-images-frontend.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-media-attachments-frontend-css" href="{{ asset('assets/css/media-attachments-frontend.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="wdt-modules-singlepage-css" href="{{ asset('assets/css/modules-singlepage.css') }}" type="text/css"
="text/css" media="all">
<link rel="stylesheet" id="wdt-comments-frontend-css" href="{{ asset('assets/css/comments-frontend.css') }}" type="
text/css" media="all">
<link rel="stylesheet" id="wdt-business-hours-frontend-css" href="{{ asset('assets/css/business-hours-frontend.css') }}" type="text/css" media="all">
<link rel="stylesheet" href="{{ asset('assets/css/dialog.min.css')}}"><link rel="stylesheet" id="elementor-frontend-css" href="{{ asset('assets/css/custom-frontend-rtl.min.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="elementor-post-8-css" href="{{ asset('assets/css/post-8.css') }}"type="text/css" media="all">
{{-- <link rel="stylesheet" id="font-awesome-5-all-css" href="{{ asset('assets/all(1).min.css" type="text/css" media="all"> --}}
<link rel="stylesheet" id="font-awesome-4-shim-css" href="{{ asset('assets/css/v4-shims.min.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="widget-divider-css" href="{{ asset('assets/css/widget-divider-rtl.min.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="e-animation-fadeInLeft-css" href="{{ asset('assets/css/fadeInLeft.min.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="e-animation-fadeIn-css" href="{{ asset('assets/css/fadeIn.min.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="widget-spacer-css" href="{{ asset('assets/css/widget-spacer-rtl.min.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="widget-image-css" href="{{ asset('assets/css/widget-image-rtl.min.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="e-animation-fadeInRight-css" href="{{ asset('assets/css/fadeInRight.min.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="e-animation-fadeInUp-css" href="{{ asset('assets/css/fadeInUp.min.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="magnific-popup-css" href="{{ asset('assets/css/jquery.magnific-popup.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="wdt-blogcarousel-css" href="{{ asset('assets/css/blogcarousel.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="elementor-post-15720-css" href="{{ asset('assets/css/post-15720.css') }}
" type="text/css" media="all">
...
<link rel="stylesheet" id="a971fbc1c37daacff709eb88c7fe0bfb-css" href="{{ asset('assets/css/css') }}" type="text/css" media="all">
<link rel="stylesheet" id="4de3aa1138d41cb03c7d9d3ddd37d9a4-css" href="{{ asset('assets/css/css(1)') }}" type="text/css" media="all">
<link rel="stylesheet" id="2f61ea5a7b8f2619662f755b6ea6047a-css" href="{{ asset('assets/css/css(2)') }}" type="text/css" media="all">
<link rel="stylesheet" id="13903dec3b9eaf7f110822ba2399eb72-css" href="{{ asset('assets/css/css(3)') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-css" href="{{ asset('assets/css/style.css') }}
" type="text/css" media="all">
...
<link rel="stylesheet" id="grassroot-icons-css" href="{{ asset('assets/css/icons.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-base-css" href="{{ asset('assets/css/base(1).css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-grid-css" href="{{ asset('assets/css/grid.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-layout-css" href="{{ asset('assets/css/layout.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-additional-css" href="{{ asset('assets/css/additional.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-widget-css" href="{{ asset('assets/css/widget(1).css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-rtl-css" href="{{ asset('assets/css/rtl(1).css') }}" type="text/css" media="all">
...
<link rel="stylesheet" id="site-loader-css" href="{{ asset('assets/css/loader-1.css') }}" type="text/css" media="all">
...
<link rel="stylesheet" id="wdt-blog-archive-minimal-css" href="{{ asset('assets/css/blog-archive-minimal.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="jquery-bxslider-css" href="{{ asset('assets/css/jquery.bxslider.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-breadcrumb-css" href="{{ asset('assets/css/breadcrumb(1).css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-comments-css" href="{{ asset('assets/css/comments.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-footer-css" href="{{ asset('assets/css/footer.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-header-css" href="{{ asset('assets/css/header(1).css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-pagination-css" href="{{ asset('assets/css/pagination.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-magnific-popup-css" href="{{ asset('assets/css/magnific-popup.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-quick-search-css" href="{{ asset('assets/css/search.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-secondary-css" href="{{ asset('assets/css/sidebar(1).css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-woo-css" href="{{ asset('assets/css/default.css') }}" type="text/css" media="all">
...
<link rel="stylesheet" id="grassroot-plus-blog-css" href="{{ asset('assets/css/blog(1).css') }}" type="text/css" media="all">
<link rel="stylesheet" id="dtplugin-nav-menu-animations-css" href="{{ asset('assets/css/nav-menu-animations.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="dtplugin-nav-menu-css" href="{{ asset('assets/css/nav-menu.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-pro-advance-field-css" href="{{ asset('assets/css/style(1).css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-pro-blog-css" href="{{ asset('assets/css/blog(2).css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-pro-post-navigation-css" href="{{ asset('assets/css/post-navigation.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-pro-auth-css" href="{{ asset('assets/css/style(2).css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="jquery-select2-css" href="{{ asset('assets/css/select2.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="grassroot-theme-css" href="{{ asset('assets/css/theme.css') }}
" type="text/css" media="all">
...
<link rel="stylesheet" id="elementor-gf-local-fraunces-css" href="{{ asset('assets/css/fraunces.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="elementor-gf-local-plusjakartasans-css" href="{{ asset('assets/css/plusjakartasans.css') }}" type="text/css" media="all">
...
<script type="text/javascript" src="{{ asset('assets/JS/jquery.blockUI.min.js') }}"id="jquery-blockui-js" data-wp-strategy="defer"></script>
...
<script type="text/javascript" src="{{ asset('assets/JS/add-to-cart.min.js') }}" id="wc-add-to-cart-js" defer="defer" data-wp-strategy="defer"></script>
