...
<link rel="stylesheet" id="elementor-post-11-css" href="{{ asset('assets/css/
post-11.css') }}
" type="text/css"
    media="all">
<link rel="stylesheet" id="widget-icon-list-css" href="{{ asset('assets/css/
custom-widget-icon-list-rtl.min.css') }}
"
    type="text/css" media="all">
<link rel="stylesheet" id="e-animation-fadeInDown-css" href="{{ asset('assets/css/
fadeInDown.min.css') }}
"
    type="text/css" media="all">
<link rel="stylesheet" id="wdt-logo-css" href="{{ asset('assets/css/
logo.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="wdt-header-icons-css" href="{{ asset('assets/css/
header-icons.css') }}
" type="text/css"
    media="all">
<link rel="stylesheet" id="wdt-header-carticons-css" href="{{ asset('assets/css/
header-carticon.css') }}
"
    type="text/css" media="all">
<link rel="stylesheet" id="wdt-heading-css" href="{{ asset('assets/css/
style(3).css') }}
" type="text/css"
    media="all">
<link rel="stylesheet" id="wdt-button-css" href="{{ asset('assets/css/
style(4).css') }}
" type="text/css"
    media="all">
<link rel="stylesheet" id="wdt-repeater-content-css" href="{{ asset('assets/css/
style(5).css') }}
" type="text/css"
    media="all">
<link rel="stylesheet" id="wdt-testimonial-css" href="{{ asset('assets/css/
style(6).css') }}
" type="text/css"
    media="all">
<link rel="stylesheet" id="wdt-counter-css" href="{{ asset('assets/css/
style(7).css') }}
" type="text/css"
    media="all">
...
<link rel="stylesheet" id="wdt-icon-box-css" href="{{ asset('assets/css/
style(8).css') }}
" type="text/css"
    media="all">
...
<link rel="stylesheet" id="wdt-column-css" href="{{ asset('assets/css/
column.css') }}
" type="text/css"
    media="all">
<link rel="stylesheet" id="wdt-advanced-slider-css" href="{{ asset('assets/css/
style(9).css') }}
" type="text/css"
    media="all">
...
<link rel="stylesheet" id="wdt-image-box-css" href="{{ asset('assets/css/
style(10).css') }}" type="text/css"
    media="all">
<link rel="stylesheet" id="jquery.magnific-image-box-popup-css"
    href="{{ asset('assets/css/jquery(1).magnific-popup.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="jquery-swiper-css" href="{{ asset('assets/css/swiper(1).min.css') }}" type="text/css"
    media="all">
<link rel="stylesheet" id="wdt-carousel-css" href="{{ asset('assets/css/carousel.css') }}" type="text/css"
    media="all">
<link rel="stylesheet" id="elementor-post-15966-css" href="{{ asset('assets/css/post-15966.css') }}"
    type="text/css" media="all">
<link rel="stylesheet" id="wdt-pricing-table-css" href="{{ asset('assets/css/style(11).css') }}" type="text/css"
    media="all">
<link rel="stylesheet" id="elementor-post-15921-css" href="{{ asset('assets/css/post-15921.css') }}"
    type="text/css" media="all">
<link rel="stylesheet" id="wdt-advanced-toggle-css" href="{{ asset('assets/css/style(12).css') }}"
    type="text/css" media="all">
<link rel="stylesheet" id="wdt-team-css" href="{{ asset('assets/css/style(13).css') }}" type="text/css"
    media="all">
...
<link rel="stylesheet" id="elementor-post-7588-css" href="{{ asset('assets/css/
post-7588.css') }}
"
    type="text/css" media="all">
<link rel="stylesheet" id="wdt-mailchimp-css" href="{{ asset('assets/css/
style(14).css') }}
" type="text/css"
    media="all">
<link rel="stylesheet" id="jquery.magnific-popup-css"
    href="{{ asset('assets/css/jquery(2).magnific-popup.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="wdt-popup-box-css" href="{{ asset('assets/css/style(15).css') }}
" type="text/css"
    media="all">
<link rel="stylesheet" id="elementor-post-15854-css" href="{{ asset('assets/css/post-15854.css') }}
"
    type="text/css" media="all">
<link rel="stylesheet" id="e-swiper-css" href="{{ asset('assets/css/e-swiper.min.css') }}
" type="text/css"
    media="all">
<link rel="stylesheet" id="widget-image-gallery-css"
    href="{{ asset('assets/css/custom-widget-image-gallery-rtl.min.css') }}
" type="text/css" media="all">
<link rel="stylesheet" id="elementor-post-15851-css" href="{{ asset('assets/css/post-15851.css') }}
"
    type="text/css" media="all">
<link rel="stylesheet" id="wdt-accordion-and-toggle-css" href="{{ asset('assets/css/style(16).css') }}
"
    type="text/css" media="all">
<link rel="stylesheet" id="elementor-post-15852-css" href="{{ asset('assets/css/post-15852.css') }}
"
    type="text/css" media="all">
<link rel="stylesheet" id="wdt-elementor-sections-css" href="{{ asset('assets/css/style(17).css') }}
"
    type="text/css" media="all">
<link rel="stylesheet" id="wdt-elementor-widgets-css" href="{{ asset('assets/css/style(18).css') }}
"
    type="text/css" media="all">
<link rel="stylesheet" id="wdt-e-animations-css" href="{{ asset('assets/css/animations.min.css') }}" type="text/css" media="all">
<script type="text/javascript" src="{{ asset('assets/js/hooks.min.js') }}
" id="wp-hooks-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/i18n.min.js') }}
...
<script type="text/javascript" src="{{ asset('assets/js/index.js') }}
" id="swv-js"></script>
...
<script type="text/javascript" id="wdt-elementor-addon-core-js-extra">
    ...
    var wdtElementorAddonGlobals = {
        "ajaxUrl": "https:\/\/wdtgrassroot.wpengine.com\/rtl-demo\/wp-admin\/admin-ajax.php"
    };
    /* ]]> */
</script>
<script type="text/javascript" src="{{ asset('assets/js/core.js') }}
" id="wdt-elementor-addon-core-js"></script>
<script type="text/javascript" id="wc-cart-fragments-js-extra">
    /* <![CDATA[ */
    var wc_cart_fragments_params = {
        "ajax_url": "\/rtl-demo\/wp-admin\/admin-ajax.php",
        "wc_ajax_url": "\/rtl-demo\/?wc-ajax=%%endpoint%%",
        "cart_hash_key": "wc_cart_hash_0e876cfb1b849e7a49d1400c965b3fa0",
        "fragment_name": "wc_fragments_0e876cfb1b849e7a49d1400c965b3fa0",
        "request_timeout": "5000"
    };
    /* ]]> */
</script>
<script type="text/javascript" src="{{ asset('assets/js/cart-fragments.min.js') }}
...
<script type="text/javascript" id="tinvwl-js-extra">
    ...
    var tinvwl_add_to_wishlist = {
        ...
        "hash_key": "ti_wishlist_data_0e876cfb1b849e7a49d1400c965b3fa0",
        "nonce": "41586ae885",
        "rest_root": "https:\/\/wdtgrassroot.wpengine.com\/rtl-demo\/wp-json\/",
        "plugin_url": "https:\/\/wdtgrassroot.wpengine.com\/rtl-demo\/wp-content\/plugins\/ti-woocommerce-wishlist\/",
        "wc_ajax_url": "\/rtl-demo\/?wc-ajax=tinvwl",
        "stats": "",
        "popup_timer": "6000"
    };
    /* ]]> */
...
<script type="text/javascript" id="grassroot-jqcustom-js-extra">
    /* <![CDATA[ */
    var ajax_object = {
        "ajax_url": "https:\/\/wdtgrassroot.wpengine.com\/rtl-demo\/wp-admin\/admin-ajax.php",
        "ajax_nonce": "c067c495f7"
    };
    /* ]]> */
</script>
<script type="text/javascript" src="{{ asset('assets/js/
custom.js') }}
" id="grassroot-jqcustom-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/
swiper.min.js') }}
...
<script type="text/javascript" id="wdt-frontend-js-extra">
    ...
    var wdtfrontendobject = {
        "pluginFolderPath": "https:\/\/wdtgrassroot.wpengine.com\/rtl-demo\/wp-content\/plugins\/",
        "pluginPath": "https:\/\/wdtgrassroot.wpengine.com\/rtl-demo\/wp-content\/plugins\/wedesigntech-portfolio\/",
        "ajaxurl": "https:\/\/wdtgrassroot.wpengine.com\/rtl-demo\/wp-admin\/admin-ajax.php",
...
<script type="text/javascript" id="elementor-frontend-js-before">
    ...
    var elementorFrontendConfig = {
        ...
        "urls": {
            "assets": "https:\/\/wdtgrassroot.wpengine.com\/rtl-demo\/wp-content\/plugins\/elementor\/assets\/",
            "ajaxurl": "https:\/\/wdtgrassroot.wpengine.com\/rtl-demo\/wp-admin\/admin-ajax.php",
            "uploadUrl": "https:\/\/wdtgrassroot.wpengine.com\/rtl-demo\/wp-content\/uploads\/sites\/3"
        },
        "nonces": {
            "floatingButtonsClickTracking": "e1d5b35165"
        },
        "swiperClass": "swiper",
        "settings": {
            "page": [],
        ...
        "post": {
            "id": 15720,
            "title": "RTL%20GrassRoot%20Site%20%E2%80%93%20Your%20SUPER-powered%20WP%20Engine%20Site",
            "excerpt": "",
            "featuredImage": false
        }
    };
...
<script type="text/javascript" src="{{ asset('assets/js/
script.js') }}
" id="grassroot-pro-auth-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/
isotope.pkgd.js') }}
...
<script type="text/javascript" src="{{ asset('assets/js/script(1).js') }}" id="wdt-counter-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/column.js') }}" id="wdt-column-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/jquery.cookie.min(1).js') }}" id="jquery.cookie-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/jquery.magnific-popup.min(1).js') }}" id="jquery.magnific-image-box-popup-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/script(2).js') }}" id="wdt-image-box-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/carousel.js') }}" id="wdt-carousel-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/script(3).js') }}" id="wdt-advanced-toggle-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/script(4).js') }}" id="wdt-mailchimp-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/jquery.magnific-popup.min(2).js') }}" id="jquery.magnific-popup-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/script(5).js') }}" id="wdt-popup-box-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/accordion.min.js') }}" id="jquery-ui-accordion-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/script(6).js') }}" id="wdt-accordion-and-toggle-js"></script>
<script type="text/javascript" src="{{ asset('assets/js/script(7).js') }}" id="wdt-elementor-sections-js"></script>
    ...
    <span class="back-to-top-icon"><i>
            <svg xmlns:xodm="http://www.corel.com/coreldraw/odm/2003" xmlns="http://www.w3.org/2000/svg" x="0px"
                ...
                <g>
                    <g>
                        <path class="bts-leaf"
                            d="M2.5,97.5c22,0.9,38.8-12.2,44.9-31.1c-3.9,6.3-11.3,9.5-21.4,7.5c-1.9-10,1.2-17.5,7.5-21.4C14.7,58.7,1.7,75.5,2.5,97.5
...
</div><svg style="display: none;" class="e-font-icon-svg-symbols"></svg><span id="PING_IFRAME_FORM_DETECTION"
