		...
		jQuery.ajax({
			...
			success: function (response) {
				...
				if(load_data == 'true') {
					...
					jQuery('.wdt-listings-item-wrapper.type1').each(function() {
						var excerptHeight = jQuery(this).find('.wdt-listings-content-wrapper').outerHeight();
						jQuery(this).find('.wdt-listings-item-top-section-content').css('--bottom-section-height', excerptHeight + 'px');
